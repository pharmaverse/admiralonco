...
- The following functions/arguments are entering the next phase of the
  ...
  **Phase 1 (message)**
  ...
  - [`filter_pd()`](https:/pharmaverse.github.io/admiralonco/update_links/reference/filter_pd.md)
    is deprecated in favor of
    [`admiral::filter_relative()`](https://pharmaverse.github.io/admiral/cran-release/reference/filter_relative.html).
    ([\#320](https://github.com/pharmaverse/admiralonco/issues/320))
...
- The
  ...
  [`filter_relative()`](https://pharmaverse.github.io/admiral/cran-release/reference/filter_relative.html).
  ([\#256](https://github.com/pharmaverse/admiralonco/issues/256))
...
- ADTTE template simplified for duration of response in line with
  [`admiral::derive_param_tte()`](https://pharmaverse.github.io/admiral/cran-release/reference/derive_param_tte.html)
  enhancement
...
- Functions that use `subject_keys` as a function argument now default
  ...
  [`set_admiral_options()`](https://pharmaverse.github.io/admiral/cran-release/reference/set_admiral_options.html)
