...
source, the function
[`admiral::derive_vars_merged()`](https://pharmaverse.github.io/admiral/cran-release/reference/derive_vars_merged.html)
can be used. If numeric date is required,
[`admiral::convert_dtc_to_dt`](https://pharmaverse.github.io/admiral/cran-release/reference/convert_dtc_to_dt.html)
, or if time part is needed,
[`admiral::convert_dtc_to_dtm()`](https://pharmaverse.github.io/admiral/cran-release/reference/convert_dtc_to_dtm.html)
...
[`admiral::derive_vars_extreme_event()`](https://pharmaverse.github.io/admiral/cran-release/reference/derive_vars_extreme_event.html)
can be used.
...
[`admiral::event()`](https://pharmaverse.github.io/admiral/cran-release/reference/event.html).
...
`ANL01FL`](https:/pharmaverse.github.io/admiralonco/update_links/articles/adrs.html#anl01fl)
...
Objects](https:/pharmaverse.github.io/admiralonco/update_links/articles/adtte.html#tteobj)
