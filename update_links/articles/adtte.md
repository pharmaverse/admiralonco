...
[`admiral::event_source()`](https://pharmaverse.github.io/admiral/cran-release/reference/event_source.html)
and the
[`admiral::censor_source()`](https://pharmaverse.github.io/admiral/cran-release/reference/censor_source.html)
...
[`admiral::derive_vars_duration()`](https://pharmaverse.github.io/admiral/cran-release/reference/derive_vars_duration.html).
...
| ADaM                                                                                           | Sample Code                                                  |
|------------------------------------------------------------------------------------------------|--------------------------------------------------------------|
| [`ADTTE`](https:/pharmaverse.github.io/admiralonco/update_links/articles/templates.html#adtte) | `admiral::use_ad_template("ADTTE", package = "admiralonco")` |
