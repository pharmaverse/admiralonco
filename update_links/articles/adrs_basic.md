...
source using
[`admiral::date_source()`](https://pharmaverse.github.io/admiral/cran-release/reference/date_source.html).
See examples below.
...
The function
[`admiral::derive_param_exist_flag()`](https://pharmaverse.github.io/admiral/cran-release/reference/derive_param_exist_flag.html)
...
The function
[`admiral::derive_var_obs_number()`](https://pharmaverse.github.io/admiral/cran-release/reference/derive_var_obs_number.html)
...
| ADaM                                                                                                     | Sample Code                                                       |
|----------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
| [`ADRS_BASIC`](https:/pharmaverse.github.io/admiralonco/update_links/articles/templates.html#adrs_basic) | `admiral::use_ad_template("ADRS_BASIC", package = "admiralonco")` |
