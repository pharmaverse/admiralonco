...
[`convert_blanks_to_na()`](https://pharmaverse.github.io/admiral/cran-release/reference/convert_blanks_to_na.html)
function.
...
| ADaM                                                                                         | Sample Code                                                 |
|----------------------------------------------------------------------------------------------|-------------------------------------------------------------|
| [`ADTR`](https:/pharmaverse.github.io/admiralonco/update_links/articles/templates.html#adtr) | `admiral::use_ad_template("ADTR", package = "admiralonco")` |
