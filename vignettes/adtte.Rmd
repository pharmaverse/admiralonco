...
function will choose the latest occurring of these.
This case is demonstrated in the below example (where `NACTDT` would be
pre-derived as first date of new anti-cancer therapy, and `LASTANDT` as date of
last assessment prior to new anti-cancer therapy or last assessment if no new
anti-cancer therapy).
