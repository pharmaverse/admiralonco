...
adrs <- adrs %>%
  derive_extreme_event(
    by_vars = get_admiral_option("subject_keys"), 
    events = list(bor_cr, bor_pr,bor_sd,bor_pd,bor_non_crpd,bor_ne,bor_ned,no_data_missing),
...
adrs <- adrs %>%
  derive_extreme_event(
    by_vars = get_admiral_option("subject_keys"),                
    events = list(cbor_cr, cbor_pr,bor_sd,bor_pd,bor_non_crpd,bor_ne,bor_ned,no_data_missing),         
