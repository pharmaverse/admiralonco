...
### 1.Progressive Disease Unconfirmed (PDu)  
-2 new bone lesions have appeared within the flare window compared to baseline.
                                       `OR`
-2 new bone lesions have appeared outside the flare window compared to the first post-treatment scan.
...
-The date of progression is the data of the scan that first documents the second lesion.See [**Bone Lesion Confirmation Guidance (The 2+2 Rule)**](#2+2rule) for further details.

### 3.Not Evaluable (NE)  
-When imaging is entirely missing or was not done, but bone lesions were present at baseline.
  
### 4.No Evidence of Disease (NED)
...
### 5.Non-Progressive Disease (Non-PD)
