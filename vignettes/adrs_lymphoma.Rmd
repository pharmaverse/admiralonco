...
plot_response <- function(dataset, page, page_size = 4) {
  ...
  ggplot(dataset %>%
         mutate(
           ...
           Response = factor(
             AVALC,
             levels = c("CMR, CAR, CR", "PMR, PAR, PR", "NMR, SAD, SD", "PMD, PAD, PD", "NE", "NED", "PSP", "ND")
           ),
           Parameter = factor(
             PARAM,
  ...
  scale_color_manual(
    values = c("CMR, CAR, CR" = "darkgreen", "PMR, PAR, PR" = "orange", "NMR, SAD, SD" = "blue", "PMD, PAD, PD" = "red", "NE" = "gray", "ND" = "black"), na.value = "grey"
  ) +
  scale_fill_manual(
    values = c("CMR, CAR, CR" = "darkgreen", "PMR, PAR, PR" = "orange", "NMR, SAD, SD" = "blue", "PMD, PAD, PD" = "red", "NE" = "gray", "ND" = "black"), na.value = "grey"
  ) +
