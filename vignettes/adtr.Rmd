...
```{r, echo=FALSE}
dataset_vignette(tr, display_vars = vars(USUBJID, TRLNKID, VISIT, LSEXP, LSASS))
```  
...
dataset_vignette(
  ...
  display_vars = vars(USUBJID, PARAMCD, PARAM, AVISIT, AVAL)
)
```  
...
dataset_vignette(
  arrange(adtr_sum, USUBJID, AVISITN),
  display_vars = vars(USUBJID, AVISIT, AVAL, NADIR, PCHG, ANL01FL, ANL02FL)
)
```  
...
dataset_vignette(
  arrange(adtr_sum, USUBJID, AVISITN),
  display_vars = vars(USUBJID, AVISIT, AVAL, NADIR, PDFL, ANL01FL, ANL03FL)
)
```  
