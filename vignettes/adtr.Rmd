...
tr <- convert_blanks_to_na(tr) %>%
  filter(TREVAL == "INVESTIGATOR" & TRGRPID == "TARGET" & TRTESTCD %in% c("LDIAM", "LPERP"))
...
In the below example, we use {'derive_var_merged_summary'} function multiple times in order to process additional variables for sum of diameter parameter, and calculate the analysis flag (`ANL01FL= Y`).  
