...
recommended to use [Creating ADRS (Including Non-standard Endpoints)](adrs.html)
instead.
...
ADaM | Sample Code
---- | --------------
[`ADRS_BASIC`](templates.html#adrs_basic) | `admiral::use_ad_template("ADRS_BASIC", package = "admiralonco")`
