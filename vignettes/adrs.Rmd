...
The function `derive_param_bor()` can be used to derive the best overall response parameter. Similar to the above function
you can optionally decide what period would you consider a `SD` or `NON-CR/NON-PD` as being eligible from. In this example,
