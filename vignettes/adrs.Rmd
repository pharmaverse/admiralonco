...
The function `derive_param_first_event()` can be used to create a new death parameter using death date from `ADSL`.
...
The function `derive_param_exist_flag()` can be used to check whether a patient has measurable disease at baseline,
...
The function `derive_var_obs_number()` can be used to derive `ASEQ`. An example call is:
