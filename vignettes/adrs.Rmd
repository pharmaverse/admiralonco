...
Here is an alternative example where those records occurring after next anti-cancer therapy are additionally
excluded (where `NACTDT` would be pre-derived as first date of next anti-cancer therapy).
