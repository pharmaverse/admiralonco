...
[`admiral::event_source()`](https:/pharmaverse.github.io/admiral/v1.3.1/cran-release/reference/event_source.html)
and the
[`admiral::censor_source()`](https:/pharmaverse.github.io/admiral/v1.3.1/cran-release/reference/censor_source.html)
...
[`admiral::derive_vars_duration()`](https:/pharmaverse.github.io/admiral/v1.3.1/cran-release/reference/derive_vars_duration.html).
...
[`admiral::derive_var_obs_number()`](https:/pharmaverse.github.io/admiral/v1.3.1/cran-release/reference/derive_var_obs_number.html)
