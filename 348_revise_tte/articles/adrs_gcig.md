...
Non-standard
Endpoints)](https:/pharmaverse.github.io/admiralonco/348_revise_tte/articles/adrs.md).
...
[`admiralonco::aval_resp()`](https:/pharmaverse.github.io/admiralonco/348_revise_tte/reference/aval_resp.md)
...
- if there is more than one assessment at a date, the worst one is
  ...
  [`admiral::derive_var_extreme_flag()`](https:/pharmaverse.github.io/admiral/v1.5.0/cran-release/reference/derive_var_extreme_flag.html)),
...
[`admiral::derive_var_relative_flag()`](https:/pharmaverse.github.io/admiral/v1.5.0/cran-release/reference/derive_var_relative_flag.html).
