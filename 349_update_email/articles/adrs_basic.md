...
| ADaM                                                                                                         | Sample Code                                                       |
|--------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
| [`ADRS_BASIC`](https:/pharmaverse.github.io/admiralonco/349_update_email/articles/templates.html#adrs_basic) | `admiral::use_ad_template("ADRS_BASIC", package = "admiralonco")` |
