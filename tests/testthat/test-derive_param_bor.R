...
adrs <- tibble::tribble(
  ...
  dplyr::mutate(PARAMCD = "OVR",
                ...
                STUDYID = "XX1234") %>%
  dplyr::select(-ADTC) %>%
  admiral::derive_vars_merged(dataset_add = adsl,
...
testthat::test_that("derive_param_bor Test 1: No source_pd", {
  ...
  actual_01 <- derive_param_bor(dataset          = adrs,
                                dataset_adsl     = adsl,
  ...
  actual_02 <- derive_param_bor(dataset          = adrs_01,
                                dataset_adsl     = adsl,
                                filter_source    = PARAMCD == "OVR",
                                source_pd        = NULL,
                                source_datasets  = NULL,
  ...
  actual_03 <- derive_param_bor(dataset          = adrs_02,
                                dataset_adsl     = adsl,
                                filter_source    = PARAMCD == "OVR",
                                source_pd        = NULL,
                                source_datasets  = NULL,
...
testthat::test_that("derive_param_bor Test 2: With source_pd", {

  pd_date <- admiral::date_source(dataset_name = "adrs_pd",
                                  date         = ADT,
                                  filter       = PARAMCD == "PD")
  ...
  adrs_pd <- adrs %>%
    dplyr::bind_rows(pd_records)

  #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  # default  BOR, All Subjects have a record after reference date ----
  #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

  actual_pd_01 <- derive_param_bor(dataset          = adrs_pd,
                                   dataset_adsl     = adsl,
                                   filter_source    = PARAMCD == "OVR",
                                   source_pd        = pd_date,
  ...
  admiral::expect_dfs_equal(base    = expected_pd_01,
