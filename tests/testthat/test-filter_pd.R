# filter_pd ----
## filter_pd Test 1: first PD in separate dataset ----
test_that("filter_pd Test 1: first PD in separate dataset", {
  adrs <- tibble::tribble(
...
## filter_pd Test 2: first PD in input dataset ----
test_that("filter_pd Test 2: first PD in input dataset", {
  adrs <- tibble::tribble(
    ~STUDYID,       ~USUBJID,      ~PARAMCD, ~AVALC, ~ADT,
    "CDISCPILOT01", "01-701-1015", "OVR",    "CR",   "2016-01-25",
    "CDISCPILOT01", "01-701-1015", "OVR",    "PD",   "2016-02-22",
...
## filter_pd Test 3: first PD derived from input dataset ----
test_that("filter_pd Test 1: first PD derived from input dataset", {
  adrs <- tibble::tribble(
    ~STUDYID,       ~USUBJID,      ~PARAMCD, ~AVALC, ~ADT,
    "CDISCPILOT01", "01-701-1015", "OVR",    "CR",   "2016-01-25",
    "CDISCPILOT01", "01-701-1015", "OVR",    "PD",   "2016-02-22",
